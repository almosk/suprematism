$(function() {
	var rectangle = (element) => {
		...
		document.querySelector(element).style.transform = 'rotate(' + Math.floor(Math.random()*360) + 'deg) translateX(' + Math.floor(Math.random()*(40-0)+0) + '%) translateY(' + Math.floor(Math.random()*(70-0)+0) + '%) scale(' + Math.floor(Math.random()*(12-6)+6)/10 + ')';
	}
